    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "חנות הסקאושים ועוד... משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'd1738d48-e213-4f14-830f-ad7b4923eeb2',
                    name: data.name || '',
                    email: data.email || '',
